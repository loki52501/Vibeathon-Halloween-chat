#!/usr/bin/env python3
"""
Database setup script for Halloween Poe Chat
Creates all necessary tables and initializes the database
"""
import os
import sys
from dotenv import load_dotenv
from database import create_tables, drop_tables, engine, DATABASE_URL
...
def create_database_if_not_exists():
    ...
    try:
        ...
        db_name = os.getenv('DB_NAME', 'poe_chat')
        db_user = os.getenv('DB_USER', 'postgres')
        db_password = os.getenv('DB_PASSWORD', 'abc123')
        db_host = os.getenv('DB_HOST', 'localhost')
        db_port = os.getenv('DB_PORT', '5432')
        
        # Use psycopg2 directly to create database (bypasses SQLAlchemy transaction issues)
        import psycopg2
...
def main():
    print("Halloween Poe Chat - Database Setup")
    print("=" * 50)
